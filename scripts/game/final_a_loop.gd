...
const ROUTINE_STEPS := [
	{
		"background": "res://assets/ui/bedroom_background.png",
		"sound": "alarm",
		"speaker": "???",
	...
	{
		"background": "res://assets/ui/bathroom_background.png",
		"foreground": "res://assets/ui/bathroom_character.png",
		"sound": "water",
		"speaker": "???",
	...
	{
		"background": "res://assets/ui/breakfast_background.png",
		"sound": "coffee",
		"speaker": "???",
	...
	{
		"background": "res://assets/ui/exit_background.png",
		"sound": "door",
		"speaker": "???",
...
const NO_SEQUENCE_STEPS := [
	{"background": "res://assets/ui/bedroom_background.png", "hold": 0.58},
	{"background": "res://assets/ui/bedroom_ciclo2_background.png", "hold": 0.50},
	{"background": "res://assets/ui/bedroom_ciclo3_background.png", "hold": 0.68},
	{"background": "res://assets/ui/bathroom_background.png", "foreground": "res://assets/ui/bathroom_character.png", "hold": 0.52},
	{"background": "res://assets/ui/bathroom_background.png", "foreground": "res://assets/ui/bathroom_character_fragment.png", "hold": 0.72},
	{"background": "res://assets/ui/exit_background.png", "hold": 0.50},
	{"background": "res://assets/ui/exit_ciclo3_door_open.png", "hold": 0.86}
]
...
func _apply_visual_step(step: Dictionary) -> void:
	var background_texture := load(str(step.get("background", "res://assets/ui/exit_background.png"))) as Texture2D
...
func _start_no_sequence() -> void:
	if _state == FlowState.NO_SEQUENCE:
		return

	_state = FlowState.NO_SEQUENCE
	choice_panel.visible = false
	_no_attempts += 1
	_play_no_glitch_audio()
	await _play_no_sequence()
	_show_office_prompt()


func _play_no_sequence() -> void:
	dialogue_box.visible = false
	for step in NO_SEQUENCE_STEPS:
		_apply_visual_step(step)
		await _play_no_glitch_burst()
		await get_tree().create_timer(float(step.get("hold", 0.5))).timeout
	dialogue_box.visible = false
...
func _play_no_glitch_burst() -> void:
	...
	for shake_index in range(shake_count):
		var shake_offset := Vector2(_rng.randf_range(-10.0, 10.0), _rng.randf_range(-6.0, 6.0)) * strength
		background.position = _background_start_position + shake_offset * 0.25
		foreground.position = _foreground_start_position + shake_offset
		choice_panel.position = _choice_start_position + shake_offset
